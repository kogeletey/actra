...
module Actra
  ...
  struct Config
    ...
    def self.default : Config
      ...
      new(default_db_path, default_install_dir, {"registry" => "https://actra.ofs.lol"}, Render::Config.default, "lefine.pro", servers, "openai", nil, default_session_dir, default_providers, [] of ExtensionConfig, [] of FileEditorConfig)
    end
    ...
    def self.load_rcl(raw : String) : Config
      ...
      new(db_path, install_dir, uri_schemes, Render::Config.default, default_server, servers, default_provider, default_model, session_dir, providers, extensions, file_editors)
    end
    ...
    def self.load_json(raw : String) : Config
      ...
      new(db_path, install_dir, uri_schemes, parse_render(any["render"]?), "lefine.pro", {} of String => ServerConfig, default_provider, default_model, session_dir, default_providers, [] of ExtensionConfig, file_editors)
    end
